...
function DrawTargetAugmentation(GC gc)
{
   ...
   targetplayerlocationstring = "";
	...
	if ( target != None )
	{
		...
		if ((weapon != None) && !weapon.bHandToHand && !bUseOldTarget && Player.bCrosshairVisible) //Just added one condition - don't draw the targeting reticule if crosshairs are hidden
		{
