...
function BindControls(optional string action)
{
    ...
    NewMenuItem("Reanimation Seconds", "Approximately how many seconds for corpses to reanimate as zombies. Leave blank or 0 to disable.");
    Slider(f.moresettings.reanimation, 0, 10000);
