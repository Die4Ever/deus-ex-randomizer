...
function PreFirstEntryMapFixes()
{
    ...
    case "01_NYC_UNATCOISLAND":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(-2374,543,-92),rotm(0,17272,0),'Standing');
        class'PlaceholderEnemy'.static.Create(self,vectm(-1211,198,-92),rotm(0,25408,0),'Standing');
        class'PlaceholderEnemy'.static.Create(self,vectm(-1843,5063,-96),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-3020,1878,-96),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(86,3088,-96),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(2879,4083,-96),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(6500,4609,-92),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(9398,2403,-92),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(7705,-2019,79),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(6618,-1526,320),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(2842,-3539,-96),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-1713,-5775,-92),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(1402,56,800),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(2231,985,1088),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(3777,-689,1088),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(4111,3260,512),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-229,1438,512),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(2766,317,2528),rotm(0,0,0),'Standing');
        break;
