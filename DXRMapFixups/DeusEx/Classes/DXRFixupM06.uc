...
function PreFirstEntryMapFixes()
{
    ...
    case "06_HONGKONG_HELIBASE":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(769,-520,144),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(1620,-87,144),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-844,-359,816),rotm(0,0,0),'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(2036,122,816),rotm(0,0,0),'Wandering');
