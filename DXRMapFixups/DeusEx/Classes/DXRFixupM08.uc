...
function PreFirstEntryMapFixes()
{
    ...
    switch(dxr.localURL)
    {
        ...
        case "08_NYC_HOTEL":
            ...
            break;
        case "08_NYC_BAR":
            npClass.static.SpawnInfoDevice(self,class'#var(prefix)NewspaperOpen',vectm(-1171.976440,250.575806,53.729687),rotm(0,0,0),'08_Newspaper01'); //Table near where Harley is in Vanilla
            break;
    }
}
