...
function PreFirstEntryMapFixes()
{
    ...
    case "15_AREA51_BUNKER":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(-2237,3225,-192), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(4234,3569,-736), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(3744,-1030,-7481), 0, 'Wandering');
    ...
    case "15_AREA51_FINAL":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(-5113,-989,-1995), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-5899,-1112,-1323), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-4795,-1596,-1357), 0, 'Wandering');
    ...
    case "15_AREA51_ENTRANCE":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(4623,210,-176), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(3314,2196,-176), 0, 'Wandering');
        class'PlaceholderEnemy'.static.Create(self,vectm(-190,-694,-180), 0, 'Wandering');
