...
function int InitGoalsRev(int mission, string map)
{
    ...
    goal = AddGoal("04_NYC_BatteryPark", "Anna Navarre", GOAL_TYPE2, 'AnnaNavarre0', PHYS_Falling);
    AddGoalActor(goal, 1, 'AllianceTrigger11', PHYS_None); //AnnaAttacksJC
    AddGoalLocation("04_NYC_BatteryPark", "Battery Park Subway", GOAL_TYPE2 | VANILLA_GOAL, vect(-4980.514648,1696.581787,-60.599060), rot(0,-49328,0));
    AddGoalLocation("04_NYC_Street", "Street Barricade", GOAL_TYPE2, vect(-367.627167,-3320.272461,-464.599823), rot(0,30000,0));
    AddGoalLocation("04_NYC_Street", "Hell's Kitchen Subway", GOAL_TYPE2, vect(3325.658447,-404.416199,-1144.588501), rot(0,-16384,0));
    AddGoalLocation("04_NYC_Street", "Outside Free Clinic", GOAL_TYPE2, vect(-1500.715332,891.878662,-464.603424), rot(0,0,0));
    AddGoalLocation("04_NYC_Hotel", "Hotel", GOAL_TYPE2, vect(30.716736,-65.753799,-16.600384), rot(0,40000,0));
