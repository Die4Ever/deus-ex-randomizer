...
function int InitGoals(int mission, string map)
{
    ...
    AddGoal("08_NYC_StreetFake", "MJ12 Assault Squad 1", GOAL_TYPE2, 'Van0', PHYS_None); //CreateGoal only runs if the goal map doesn't match
    AddGoal("08_NYC_StreetFake", "MJ12 Assault Squad 2", GOAL_TYPE2, 'Van1', PHYS_None); //CreateGoal only runs if the goal map doesn't match
    AddGoalLocation("08_NYC_Street", "Alley", GOAL_TYPE2 | VANILLA_GOAL, vect(-1893.816406,-614.223816,-445.429260), rot(0, -32616, 0));
    AddGoalLocation("08_NYC_Street", "Road to NSF HQ", GOAL_TYPE2 | VANILLA_GOAL, vect(-1758.505249,-1704.474976,-445.434998), rot(0, 32832, 0));
    AddGoalLocation("08_NYC_Street", "Basketball Court", GOAL_TYPE2, vect(2914,-3000,-429), rot(0, 7200, 0));
    AddGoalLocation("08_NYC_Street", "Smuggler Front Door", GOAL_TYPE2, vect(2292.625977,-1448.627441,-445.429016), rot(0, 0, 0));
    AddGoalLocation("08_NYC_Street", "Hotel", GOAL_TYPE2, vect(1005.300781,201.109436,-445.432312), rot(0, -16240, 0));
...
function CreateGoal(out Goal g, GoalLocation Loc)
{
    ...
    case "MJ12 Assault Squad 2":
        ...
        g.actors[0].a = van;
        van.FamiliarName="Flower Delivery Van";
