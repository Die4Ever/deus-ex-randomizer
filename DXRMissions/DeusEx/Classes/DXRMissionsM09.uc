...
function int InitGoals(int mission, string map)
{
    ...
    case "09_NYC_SHIPBELOW":
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',320,343,"W",goal, loc,"A weld point can be located at the North end of the Engine Room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',166,204,"W",goal, loc,"A weld point can be located on the balcony of the Bilge Pump room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',212,269,"W",goal, loc,"A weld point can be located in the upper hallway next to the Bilge Pump room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',135,135,"W",goal, loc,"A weld point can be located on the South East side of the Electrical Room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',47,50,"W",goal, loc,"A weld point can be located on the South side of the Helipad.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',130,247,"W",goal, loc,"A weld point can be located in the Helipad Storage Room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',97,368,"W",goal, loc,"A weld point can be located in the Air Control room of the Helipad.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',175,286,"W",goal, loc,"A weld point can be located inside the main ventilation Fan shaft.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',318,263,"W",goal, loc,"A weld point can be located in the control tower in the Engine Room.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',381,148,"W",goal, loc,"A weld point can be located on the North West side of the Engine Room.  This is a vanilla location.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',152,180,"W",goal, loc,"A weld point can be located on the North East side of the Electical Room.  This is a vanilla location.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',5,109,"W",goal, loc,"A weld point can be located on the East side of the Helipad.  This is a vanilla location.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',171,11,"W",goal, loc,"A weld point can be located next to the Bilge Pumps.  This is a vanilla location.");
        ...
        AddMapMarker(class'Image09_NYC_Ship_Bottom',385,44,"W",goal, loc,"A weld point can be located on the South West side of the Engine Room, behind a wall.  This is a vanilla location.");
