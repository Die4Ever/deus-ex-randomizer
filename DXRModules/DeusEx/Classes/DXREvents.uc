...
defaultproperties
{
    ...
    bingo_options(93)=(event="MJ12Troop_ClassUnconscious",desc="Knock out %s MJ12 Troopers",desc_singular="Knock out 1 MJ12 Trooper",max=25,missions=57204)
    ...
    bingo_options(226)=(event="NicoletteHouseTour",desc="Tour %s parts of Chateau DuClare with Nicolette",desc_singular="Tour 1 part of Chateau DuClare with Nicolette",max=5,missions=1024)
    ...
    bingo_options(231)=(event="DuClareKeys",desc="Collect %s different keys around Chateau DuClare",desc_singular="Collect 1 key in Chateau DuClare",max=3,missions=1024)
