...
defaultproperties
{
    ...
    bingo_options(64)=(event="FlushUrinal",desc="Use %s urinals",desc_singular="Use 1 urinal",max=20,missions=22398)
    ...
    bingo_options(78)=(event="UNATCOTroop_ClassDead",desc="Kill %s UNATCO Troopers",desc_singular="Kill 1 UNATCO Trooper",max=15,missions=318)
    bingo_options(79)=(event="Terrorist_ClassDead",desc="Kill %s NSF Terrorists",desc_singular="Kill 1 NSF Terrorist",max=15,missions=46)
    ...
    bingo_options(89)=(event="HumanStompDeath",desc="Stomp %s humans to death",desc_singular="Stomp 1 human to death",max=3)
    bingo_options(90)=(event="Rat_ClassDead",desc="Kill %s rats",desc_singular="Kill 1 rat",max=30,missions=53118)
    bingo_options(91)=(event="UNATCOTroop_ClassUnconscious",desc="Knock out %s UNATCO Troopers",desc_singular="Knock out 1 UNATCO Trooper",max=15,missions=318)
    bingo_options(92)=(event="Terrorist_ClassUnconscious",desc="Knock out %s NSF Terrorists",desc_singular="Knock out 1 NSF Terrorist",max=15,missions=46)
    bingo_options(93)=(event="MJ12Troop_ClassUnconscious",desc="Knock out %s MJ12 Troopers",desc_singular="Knock out 1 MJ12 Trooper",max=25,missions=57188)
    bingo_options(94)=(event="MJ12Commando_ClassUnconscious",desc="Knock out %s MJ12 Commandos",desc_singular="Knock out 1 MJ12 Commando",max=2,missions=56384)
    ...
    bingo_options(104)=(event="GreeneArticles",desc="Read %s newspaper articles by Joe Greene",desc_singular="Read 1 newspaper article by Joe Greene",max=4,missions=270)
    ...
    bingo_options(107)=(event="Gray_ClassDead",desc="Kill %s Grays",desc_singular="Kill 1 Gray",max=5,missions=32832)
    bingo_options(108)=(event="CloneCubes",desc="Read about %s clones in Area 51",desc_singular="Read about 1 clone in Area 51",max=4,missions=32768)
    ...
    bingo_options(134)=(event="GibbedPawn",desc="Blow up %s people",desc_singular="Blow up 1 person",max=15)
#endif
    ...
    bingo_options(138)=(event="CommsPit",desc="Check the SATCOM wiring %s times",desc_singular="Check the SATCOM wiring 1 time",max=3,missions=58)
    ...
    bingo_options(167)=(event="BlueFusionReactors",desc="Deactivate %s blue fusion reactors",desc_singular="Deactivate 1 blue fusion reactor",max=4,missions=32768)
    bingo_options(168)=(event="A51UCBlocked",desc="Close the doors to %s UCs in Area 51",desc_singular="Close the door to 1 UC in Area 51",max=3,missions=32768)
    ...
    bingo_options(177)=(event="Sodacan_Activated",desc="Drink %s cans of soda",desc_singular="Drink 1 can of soda",max=75,use_item_goal=INT_TRUE)
    bingo_options(178)=(event="BallisticArmor_Activated",desc="Use %s Ballistic Armors",desc_singular="Use 1 Ballistic Armor",max=3,missions=57212,use_item_goal=INT_TRUE)
    ...
    bingo_options(182)=(event="HazMatSuit_Activated",desc="Use %s HazMat Suits",desc_singular="Use 1 HazMat Suit",max=3,missions=54866,use_item_goal=INT_TRUE)
    bingo_options(183)=(event="AdaptiveArmor_Activated",desc="Use %s Thermoptic Camos",desc_singular="Use 1 Thermoptic Camo",max=3,missions=5513,use_item_goal=INT_TRUE)
    bingo_options(184)=(event="DrinkAlcohol",desc="Drink %s bottles of alcohol",desc_singular="Drink 1 bottle of alcohol",max=75,use_item_goal=INT_TRUE)
    ...
    bingo_options(187)=(event="TechGoggles_Activated",desc="Use %s tech goggles",desc_singular="Use tech goggles",max=3,missions=54346,use_item_goal=INT_TRUE)
    bingo_options(188)=(event="Rebreather_Activated",desc="Use %s rebreathers",desc_singular="Use 1 rebreather",max=3,missions=55400,use_item_goal=INT_TRUE)
    ...
    bingo_options(195)=(event="FireExtinguisher_Activated",desc="Use %s fire extinguishers",desc_singular="Use 1 fire extinguisher",max=10,use_item_goal=INT_TRUE)
    ...
    bingo_options(199)=(event="PinballWizard",desc="Play %s different pinball machines",desc_singular="Play 1 pinball machine",max=10,missions=37246)
    ...
    bingo_options(222)=(event="ReadJCEmail",desc="Check your email %s times",desc_singular="Check your email 1 time",max=3,missions=122)
    ...
    bingo_options(267)=(event="ScubaDiver_ClassDead",desc="Kill %s SCUBA Divers",desc_singular="Kill 1 SCUBA Diver",max=3,missions=16384)
    ...
    bingo_options(307)=(event="UCVentilation",desc="Destroy %s ventilation fans in the Ocean Lab",desc_singular="Destroy 1 ventilation fan in the Ocean Lab",max=6,missions=16384)
