...
function TestScoring()
{
    ...
    testint(dxr.flags.ScoreFlags(), 9360, "score bonus for Hard");

    dxr.flags.SetDifficulty(3);
    testint(dxr.flags.ScoreFlags(), 11450, "score bonus for Extreme");

    dxr.flags.SetDifficulty(4);
    testint(dxr.flags.ScoreFlags(), 13985, "score bonus for Impossible");
