...
public class DeusEx : SimpleTCPPack
{
    ...
    {
        //General Effects
        new Effect("Trigger the Killswitch", "kill"){Price = 75,Description = "Instantly kill the player by simply flipping a switch."},
        new Effect("Poison the Player", "poison"){Price = 15,Description = "Give the player a nice dose of poison"},
        new Effect("Glass Legs", "glass_legs"){Price = 5,Description = "Take away all but one health from each of the players legs"},
        new Effect("Give Health (x10)", "give_health") { Quantity = 100, Price = 1,Description = "Give the player some health!" },
        new Effect("Set On Fire", "set_fire"){Price = 15,Description = "Burn baby burn!"},
        new Effect("Full Heal", "full_heal"){Price = 10,Description = "Fully heal the player"},
        new Effect("Drunk Mode", "drunk_mode"){Price = 3,Description = "Let the player overindulge with some nice alcohol"},
        ...
        new Effect("Give Player EMP Field", "emp_field"){Price = 20,Description = "Make all electronics around the player go haywire for 15 seconds!",Duration=15},
        ...
        new Effect("Ice Physics!","ice_physics"){Price = 3,Description = "Make the ground freeze up and become as slippery as a skating rink!",Duration=60},
        new Effect("Take Double Damage","dmg_double"){Price = 5,Description = "Make the player weaker so they take double damage!",Duration=60},
        new Effect("Take Half Damage","dmg_half"){Price = 3,Description = "Make the player tougher so they take half damage!",Duration=60},
        ...
        new Effect ("Swap all item positions","swap_items"){Price = 3,Description = "Shuffles all the inventory items in the level into each others locations!"}, //New for fifth Crowd Control batch
        new Effect ("Float Away","floaty_physics"){Price = 20,Description = "Suddenly gravity feels very light and everything starts floating up into the sky...",Duration=30}, //New for second Crowd Control batch
        ...
        new Effect ("Invert Mouse Controls","invert_mouse"){Price = 10,Description = "Up is down and down is up!",Duration=60}, //New for second Crowd Control batch
        new Effect ("Invert Movement Controls","invert_movement"){Price = 10,Description = "Right is left, left is right, forwards is backwards, and backwards is forwards!",Duration=60}, //New for second Crowd Control batch
        new Effect ("Earthquake","earthquake"){Price = 10,Description = "Set off a massive earthquake in the game!",Duration=30}, //New for fourth Crowd Control batch
        ...
        new Effect ("Eat Beans", "eat_beans"){Price = 3,Description = "Force feed the player a bunch of beans and witness the consequences!",Duration=60}, //New for fourth Crowd Control batch
        new Effect ("Fire the current weapon", "fire_weapon"){Price = 2,Description = "Fire whatever weapon the player is holding!"}, //New for fourth Crowd Control batch
        ...
        new Effect ("Quick Load", "quick_load"){Price = 15,Description = "Hope that last quick save wasn't too far back, or in too much danger!"}, //New for fourth Crowd Control batch
        new Effect ("Drop a piano on the player", "drop_piano"){Price = 5,Description = "Spawn a piano above the player to drop it on them, just like in the cartoons!"}, //New for fifth Crowd Control batch, v2.6
        ...
        new Effect ("Heal all Enemies", "heal_all_enemies"){Price = 5,Description = "Fully heal all enemies in the current level!"}, //New for fifth Crowd Control batch, v2.6
        new Effect ("Make Player Radioactive", "radioactive"){Price = 5,Description = "The player becomes radioactive and starts hurting nearby people!",Duration=60}, //New for fifth Crowd Control batch, v2.6
        new Effect ("Corpse Explosion", "corpse_explosion"){Price = 7,Description = "Fill up to 5 nearby corpses with energy, causing them to explode violently!"}, //New for fifth Crowd Control batch, v2.6
        new Effect ("Lose your Marbles", "drop_marbles"){Price = 2,Description = "Oops, JC dropped all the marbles!"}, //New for sixth Crowd Control batch
        new Effect ("Drop some Pamphlets", "spam_datacubes"){Price = 2,Description = "Air drop a selection of informative datacubes around the level!"}, //New for sixth Crowd Control batch
        ...
        new Effect ("Blood for the Blood God", "blood_god"){Price = 1,Description = "Bestow an offering to the Blood God and make everything bleed!", Duration = 60}, //New for sixth Crowd Control batch
        ...
        new Effect ("Spawn Medical Bot", "spawnfriendly_medicalbot") { Category = "Spawn Enemies/Allies",Price = 25,Description = "Spawn a medical bot for healing and augmentation installation" }, //New for fourth Crowd Control batch
        new Effect ("Spawn Repair Bot", "spawnfriendly_repairbot") { Category = "Spawn Enemies/Allies",Price = 15,Description = "Spawn a repair bot to restore bioelectric energy" }, //New for fourth Crowd Control batch
        ...
        new Effect ("Spawn hostile Security Bot", "spawnenemy_securitybot4") { Category = "Spawn Enemies/Allies",Price = 20,Description = "Spawn a security bot to fill the player with holes" }, //New for fourth Crowd Control batch
        ...
        new Effect ("Spawn hostile Military Bot", "spawnenemy_militarybot") { Category = "Spawn Enemies/Allies",Price = 30,Description = "Spawn a huge military bot to blow the player to pieces" }, //New for fourth Crowd Control batch
        new Effect ("Spawn friendly Military Bot", "spawnfriendly_militarybot") { Category = "Spawn Enemies/Allies",Price = 20,Description = "Spawn a military bot to give the player a hand" }, //New for fourth Crowd Control batch
        new Effect ("Spawn hostile Doberman", "spawnenemy_doberman") { Category = "Spawn Enemies/Allies",Price = 2,Description = "Spawn a doberman to tear you to shreds" }, //New for fourth Crowd Control batch
        new Effect ("Spawn hostile Greasel", "spawnenemy_greasel") { Category = "Spawn Enemies/Allies",Price = 5,Description = "Spawn a hostile greasel to poison you to death" }, //New for fourth Crowd Control batch
        ...
        new Effect("Give a Medkit", "give_medkit") { Category = "Give Items",Price = 5,Description = "Give the player a medkit" }, //Moved into new folder for third batch
        new Effect("Give a Biocell", "give_bioelectriccell") { Category = "Give Items",Price = 5,Description = "Give the player a bioelectric cell" }, //Moved into new folder for third batch
        new Effect("Give a Fire Extinguisher", "give_fireextinguisher") { Category = "Give Items",Price = 2,Description = "Give the player a fire extinguisher" }, //New for third Crowd Control batch
        new Effect("Give a Ballistic Armor", "give_ballisticarmor") { Category = "Give Items",Price = 2,Description = "Give the player ballistic armor" }, //New for third Crowd Control batch
        new Effect("Give a Lockpick", "give_lockpick") { Category = "Give Items",Price = 5,Description = "Give the player a lockpick" }, //New for third Crowd Control batch
        new Effect("Give a Multitool", "give_multitool") { Category = "Give Items",Price = 5,Description = "Give the player a multitool" }, //New for third Crowd Control batch
        new Effect("Give a Rebreather", "give_rebreather") { Category = "Give Items",Price = 2,Description = "Give the player a rebreather" }, //New for third Crowd Control batch
        new Effect("Give a Thermoptic Camo", "give_adaptivearmor") { Category = "Give Items",Price = 5,Description = "Give the player thermoptic camo" }, //New for third Crowd Control batch
        new Effect("Give a HazMat Suit", "give_hazmatsuit") { Category = "Give Items",Price = 2,Description = "Give the player a hazmat suit" }, //New for third Crowd Control batch
        ...
        new Effect("Give a set of Tech Goggles", "give_techgoggles") { Category = "Give Items",Price = 2,Description = "Give the player a set of tech goggles" }, //New for Fourth Crowd Control batch
        ...
        new Effect("Drop a Live LAM", "drop_lam") { Category = "Drop Live Grenade",Price = 15,Description = "Drop a LAM on the ground, ready to explode!" },
        new Effect("Drop a Dud LAM", "drop_dudlam") { Category = "Drop Live Grenade",Price = 2,Description = "Drop a LAM on the ground, except it's not going to explode!" }, //New for SEVENTH Crowd Control batch
        ...
        new Effect("Drop a Live Scrambler Grenade", "drop_nanovirusgrenade") { Category = "Drop Live Grenade",Price = 3,Description = "Drop a scrambler grenade on the ground, ready to take control of bots or scramble the players augs!" },


        //Weapons
        //new Effect("Give Weapons","giveweapon",ItemKind.Folder),

        new Effect("Give Flamethrower", "give_weaponflamethrower") { Category = "Give Weapon",Price = 10,Description = "Give the player a flamethrower" },
        new Effect("Give GEP Gun", "give_weapongepgun") { Category = "Give Weapon",Price = 10,Description = "Give the player a GEP gun" },
        new Effect("Give Dragon Tooth Sword", "give_weaponnanosword") { Category = "Give Weapon",Price = 50,Description = "Give the player a Dragon Tooth Sword" },
        new Effect("Give Plasma Rifle", "give_weaponplasmarifle") { Category = "Give Weapon",Price = 10,Description = "Give the player a plasma rifle" },
        new Effect("Give LAW", "give_weaponlaw") { Category = "Give Weapon",Price = 10,Description = "Give the player a LAW" },
        new Effect("Give Sniper Rifle", "give_weaponrifle") { Category = "Give Weapon",Price = 5,Description = "Give the player a sniper rifle" },
        ...
        new Effect("Give Pepper Spray", "give_weaponpeppergun") { Category = "Give Weapon",Price = 3,Description = "Give the player pepper spray" },  //New for second Crowd Control batch
        ...
        new Effect("Give LAM", "give_weaponlam") { Category = "Give Weapon",Price = 5,Description = "Give the player a LAM" },  //New for second Crowd Control batch
        new Effect("Give EMP Grenade", "give_weaponempgrenade") { Category = "Give Weapon",Price = 3,Description = "Give the player an EMP grenade" },  //New for second Crowd Control batch
        ...
        new Effect("Give PS40","give_weaponhideagun") { Category = "Give Weapon",Price = 5,Description = "Give the player a PS40" },
        new Effect("Give all enemies a LAW", "giveenemyweapon_weaponlaw") { Category = "Give Weapon",Price = 30,Description = "Give all enemies a LAW" }, //New for fifth Crowd Control batch, v2.6
        new Effect("Give all enemies a PS40", "giveenemyweapon_weaponhideagun") { Category = "Give Weapon",Price = 20,Description = "Give all enemies a PS40" }, //New for fifth Crowd Control batch, v2.6

        //Ammo
        //new Effect("Give Ammo","giveammo",ItemKind.Folder),

        new Effect("Give 10mm Ammo (Pistols)", "give_ammo10mm") {  Quantity = 100, Category = "Give Ammo",Price = 3,Description = "Give the player some 10mm ammo" }, //New for second Crowd Control batch
        new Effect("Give 20mm Ammo (Assault Rifle)", "give_ammo20mm") {  Quantity = 100, Category = "Give Ammo",Price = 10,Description = "Give the player some 20mm high explosive ammo" }, //New for second Crowd Control batch
        ...
        new Effect("Give Sabot Shells", "give_ammosabot") {  Quantity = 100, Category = "Give Ammo",Price = 5,Description = "Give the player some Sabot shells" }, //New for second Crowd Control batch
        new Effect("Give Shotgun Shells", "give_ammoshell") {  Quantity = 100, Category = "Give Ammo",Price = 3,Description = "Give the player some shotgun shells" }, //New for second Crowd Control batch

        //Camera Effects
        new Effect ("Flip camera upside down","flipped"){Category = "Camera Effects",Price = 7,Description = "Australia mode",Duration=60}, //New for fourth Crowd Control batch
        new Effect ("Flip camera sideways","limp_neck"){Category = "Camera Effects",Price = 7,Description = "Just turn the screen to the side!",Duration=60}, //New for fourth Crowd Control batch
        new Effect ("Do a barrel roll!","barrel_roll"){Category = "Camera Effects",Price = 10,Description = "The camera does an ever so slow barrel roll over the course of a minute...",Duration=60}, //New for fourth Crowd Control batch
