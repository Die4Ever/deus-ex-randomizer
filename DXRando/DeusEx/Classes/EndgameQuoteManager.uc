...
function LoadQuotes()
{
    ...
    AddQuote("YOU MEAN TO SAY YOU WOULD LIKE TO BE TOTALLY DESTROYED?  WELL, I CAN MAKE YOUR WISH COME TRUE!", "AGAHNIM");
    ...
    AddQuote("MY DEAR, GAIA!  PLEASE LISTEN TO ME.  FROM THIS TIME FORWARD, EVERY 1 BILLION YEARS, YOU WILL HAVE CHILDREN CALLED \"LIFE\"", "THE SUN"); //E.V.O.: Search for Eden
