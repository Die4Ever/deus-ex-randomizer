...
static function String GetDayNumSuffix(int day)
{
...
static function string ConstructMonthDayStr(int month, int day)
{
    return GetMonthName(month) @ string(day) $ GetDayNumSuffix(day);
}

static function string ConstructTimeOfDayStr(int hour, int minute)
{
    local bool isPM;
    local string timeStr;
