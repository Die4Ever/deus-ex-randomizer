...
function PreFirstEntryMapFixes()
{
    ...
    case "12_VANDENBERG_CMD":
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(-1702,1839,-2000),,'Sitting'); // couches near hazard lab
        ...
        class'PlaceholderEnemy'.static.Create(self,vectm(19424, 18720, -2048));// behind the lobby chair (no room to sit)
        class'PlaceholderEnemy'.static.Create(self,vectm(-422.848267, 1350.189575, -2004.884888));// lobby
    ...
    case "12_Vandenberg_gas":
        ...
        for (ce = con.eventList; ce != None; ce = ce.nextEvent) {
            if (ConEventCheckFlag(ce) != None && ConEventCheckFlag(ce).setLabel == "Dead") {
                cet = ConEventTrigger(NewConEvent(con,ce,class'ConEventTrigger'));
