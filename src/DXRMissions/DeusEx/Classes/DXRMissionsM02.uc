...
function int InitGoals(int mission, string map)
{
    ...
    case "02_NYC_BATTERYPARK":
        ...
        if (!class'DXRMapVariants'.static.IsGMDXMaps(player())){
            ...
            //GMDX has a trashcan in *exactly* the normal location, nudge it slightly to the side
            AddGoalLocation("02_NYC_BATTERYPARK", "By the desk", NORMAL_GOAL, vect(-557,-666,-397), rot(0, -24786, 0));
        }
