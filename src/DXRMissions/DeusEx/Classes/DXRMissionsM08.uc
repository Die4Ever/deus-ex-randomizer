...
function int InitGoals(int mission, string map)
{
    ...
    if(!#defined(gmdx)){
        ...
        //GMDX shifted the vending machines over a bit
        AddGoalLocation("08_NYC_FreeClinic", "Clinic", GOAL_TYPE1 | VANILLA_GOAL, vect(-115, -405, -272.399506), rot(0,31640,0));
        AddGoalLocation("08_NYC_Underground", "Sewers", GOAL_TYPE1, vect(591, -65, -784), rot(0,32768,0));
    }
