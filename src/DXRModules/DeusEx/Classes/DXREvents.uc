...
//#region Bingo Options
    ...
    bingo_options(183)=(event="AdaptiveArmor_Activated",desc="Use %s Thermoptic Camos",desc_singular="Use a Thermoptic Camo",max=3,missions=55132)
    ...
    bingo_options(241)=(event="LightVandalism",desc="Perform %s acts of light vandalism",desc_singular="Perform an act of light vandalism",max=40,missions=57214)
    bingo_options(242)=(event="FightSkeletons",desc="Destroy %s skeleton parts",desc_singular="Destroy a skeleton part",max=10,missions=19536)
    bingo_options(243)=(event="TrophyHunter",desc="Trophy Hunter (%s)",max=10,missions=1146)
    bingo_options(244)=(event="SlippingHazard",desc="Create %s potential slipping hazards",desc_singular="Create a potential slipping hazard",max=5,missions=894)
    bingo_options(245)=(event="Dehydrated",desc="Stay dehydrated %s times",desc_singular="Stay dehydrated",max=15,missions=40830)
#ifndef vmd
    ...
    bingo_options(303)=(event="VandenbergComputerElec",desc="Disable %s electrical panels in the Vandenberg computer room",desc_singular="Disable an electrical panel in the Vandenberg computer room",max=2,missions=4096)
