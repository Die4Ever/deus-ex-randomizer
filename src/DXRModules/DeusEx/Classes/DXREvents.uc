...
//#region Bingo Options
    ...
    bingo_options(203)=(event="Terrorist_peeptime",desc="Watch Terrorists for %s seconds",desc_singular="Watch Terrorists for 1 second",max=30,missions=#bit(1,2,3,5))
    bingo_options(204)=(event="UNATCOTroop_peeptime",desc="Watch UNATCO Troopers for %s seconds",desc_singular="Watch UNATCO Troopers for 1 second",max=30,missions=#bit(1,2,3,4,5,8))
    bingo_options(205)=(event="MJ12Troop_peeptime",desc="Watch MJ12 Troopers for %s seconds",desc_singular="Watch MJ12 Troopers for 1 second",max=30,missions=#bit(2,5,6,8,9,10,11,12,14,15))
    bingo_options(206)=(event="MJ12Commando_peeptime",desc="Watch MJ12 Commandos for %s seconds",desc_singular="Watch MJ12 Commandos for 1 second",max=15,missions=#bit(6,10,11,12,14,15))
    bingo_options(207)=(event="PawnAnim_Dance",desc="You can dance if you want to",max=1,missions=#bit(2,4,6,8,10))
    bingo_options(208)=(event="BirdWatching_peeptime",desc="Watch birds for %s seconds",desc_singular="Watch birds for 1 second",max=30,missions=#bit(1,2,3,4,5,6,8,9,10,11,12,14))
    ...
    bingo_options(241)=(event="LightVandalism_DestroyDeco",desc="Perform %s acts of light vandalism",desc_singular="Perform 1 act of light vandalism",max=40,missions=#bit(1,2,3,4,5,6,8,9,10,11,12,14,15))
    bingo_options(242)=(event="FightSkeletons_DestroyDeco",desc="Destroy %s skeleton parts",desc_singular="Destroy 1 skeleton part",max=10,missions=#bit(4,6,10,11,14))
    bingo_options(243)=(event="TrophyHunter_DestroyDeco",desc="Trophy Hunter",max=10,missions=#bit(1,3,4,5,6,10))
    bingo_options(244)=(event="SlippingHazard_DestroyDeco",desc="Create %s potential slipping hazards",desc_singular="Create 1 potential slipping hazard",max=5,missions=#bit(1,2,3,4,5,6,8,9))
    bingo_options(245)=(event="Dehydrated_DestroyDeco",desc="Stay dehydrated %s times",desc_singular="Stay dehydrated 1 time",max=15,missions=#bit(1,2,3,4,5,6,8,9,10,11,12,15))
#ifndef vmd
