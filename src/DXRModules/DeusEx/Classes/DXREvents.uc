...
//#region Bingo Options
    ...
    bingo_options(203)=(event="Terrorist_peeptime",desc="Watch Terrorists for %s seconds",desc_singular="Watch a Terrorist for a second",max=30,missions=#bit(1,2,3,5))
    bingo_options(204)=(event="UNATCOTroop_peeptime",desc="Watch UNATCO Troopers for %s seconds",desc_singular="Watch a UNATCO Trooper for a second",max=30,missions=#bit(1,2,3,4,5,8))
    bingo_options(205)=(event="MJ12Troop_peeptime",desc="Watch MJ12 Troopers for %s seconds",desc_singular="Watch an MJ12 Trooper for a second",max=30,missions=#bit(2,5,6,8,9,10,11,12,14,15))
    bingo_options(206)=(event="MJ12Commando_peeptime",desc="Watch MJ12 Commandos for %s seconds",desc_singular="Watch an MJ12 Commando for a second",max=15,missions=#bit(6,10,11,12,14,15))
    bingo_options(207)=(event="PawnAnim_Dance",desc="You can dance if you want to",max=1,missions=#bit(2,4,6,8,10))
    bingo_options(208)=(event="BirdWatching_peeptime",desc="Watch birds for %s seconds",desc_singular="Watch a bird for a second",max=30,missions=#bit(1,2,3,4,5,6,8,9,10,11,12,14))
    ...
    bingo_options(372)=(event="PoolTableStripeBallSunk",desc="Sink 5 striped pool balls",desc_singular="Sink a striped pool ball",max=5,missions=#bit(2,3,4,6,8,15),do_not_scale=true)
    bingo_options(373)=(event="PoolTableSolidBallSunk",desc="Sink 5 solid pool balls",desc_singular="Sink a solid pool ball",max=5,missions=#bit(2,3,4,6,8,15),do_not_scale=true)
    bingo_options(374)=(event="PoolTableBallSunk",desc="Sink 5 pool balls",desc_singular="Sink a pool ball",max=5,missions=#bit(2,3,4,6,8,15),do_not_scale=true)
