...
function CheckOfflineUpdates()
{
    ...
    if(DateAtLeast(2052, 1, 1)) {
        newsdates[num] = "2052-01-01";
        newsheaders[num] = "Is Deus Ex Real Life Yet?";
        newstexts[num] = "Thank you for still playing this mod in the year " $ Level.Year $ ", but you're probably extremely behind on updates. The project is open source, so even if we have moved on, maybe someone else has taken over?";
        num++;
        campaign = "2052";
    }
