...
function string ReplaceKeywords(String origStr, String viewer)
{
    local String endStr,s;
    local int num1,num2;

    endStr = origStr;

    endStr = ccLink.ccModule.ReplaceText(endStr,"%VIEWERNAME%",viewer); //Insert the viewer name

    s = ccLink.ccModule.ConstructTimeOfDayStr(Level.Hour,Level.Minute);
    endStr = ccLink.ccModule.ReplaceText(endStr,"%CURTIME%",s); //Insert the current time

    num1 = Rand(24);
    num2 = Rand(60);
    s = ccLink.ccModule.ConstructTimeOfDayStr(num1,num2);
    endStr = ccLink.ccModule.ReplaceText(endStr,"%WRONGTIME%",s); //Insert the a random time

    s = ccLink.ccModule.ConstructMonthDayStr(Level.Month, Level.Day);
    endStr = ccLink.ccModule.ReplaceText(endStr,"%CURDATE%",s); //Insert the current date

    num1 = Rand(12)+1;
    num2 = Rand(31)+1; //For a wrong date, we actually don't care if the day is longer than the month :D
    s = ccLink.ccModule.ConstructMonthDayStr(num1, num2);
    endStr = ccLink.ccModule.ReplaceText(endStr,"%WRONGDATE%",s); //Insert a random date
...
function AskRandomQuestion(String viewer) {
    ...
    question   = ReplaceKeywords(question,viewer);
    answers[0] = ReplaceKeywords(answers[0],viewer);
    answers[1] = ReplaceKeywords(answers[1],viewer);
    answers[2] = ReplaceKeywords(answers[2],viewer);
...
function string RandomSpamDatacubeText()
{
    switch(Rand(36)){
        case 0:   return "Enlarge your Dragon Tooth!  Contact %VIEWERNAME% Corp. for more details on how YOU can gain 4 inches TODAY!";
        case 1:   return "You've won the Gray Death vaccine lottery!  As thanks for signing up for more information on any vaccine news, you have won 1000 credits!"$"  For more details, please send your full name, date of birth, occupation, drivers license, and 5000 credits to %VIEWERNAME%!";
        case 2:   return "Your NYCNet account has violated security policies and will be deleted in three (3) days!  If you would like to keep your account,"$" please send a picture of your ID as well as your mothers maiden name to %VIEWERNAME% to prove your innocence.  Revalidating your account will cost a minimum fee of 12000 credits.";
        case 3:   return "Please update your payment details.  Your account with Classic Movies is missing information and may be locked if not provided within one (1) week.  Please respond to %VIEWERNAME% for more details.";
        case 4:   return "You have been been selected as the lucky winner of the Nuka Cola online draw!  Contact %VIEWERNAME% for more information on how to claim your lifetime supply.|n|n|n|n(Lifetime is defined as 1 year under current conditions)";
        case 5:   return "Register for YOUR opportunity to receive the Gray Death vaccine NOW!  Don't miss your shot, this is a first-come, first-served offer!  Send your information to %VIEWERNAME% to get in line RIGHT NOW!";
        case 6:   return "You are a FOOL!|n|n-%VIEWERNAME%";
        case 7:   return "ICARUS HAS FOUND YOU... And wants to offer you an exclusive vacation offer to visit beautiful Paris!  Please contact your closest MJ12 associate (%VIEWERNAME%) to set up your vacation today!";
        case 8:   return "Your package from %VIEWERNAME% has been delivered to the 'Ton Hotel!  Please come to pick it up promptly, as it may be returned otherwise.  This package requires a payment of 7500 credits before being handed off.";
        case 9:   return "I have been watching and recording you through your Infolink and I know EVERYTHING that you've done.  If you want to keep this information private from your brother, Paul, you will need to send 400 PageCoins"$" to the digital wallet held under the name %VIEWERNAME%.  If you do not pay within three (3) days, these videos will be sent to Paul.";
        case 10:  return "Free guitar lessons!  Please contact %VIEWERNAME% to set up a lesson today!";
        case 11:  return "Lost dog!|n|nHave you seen my dog?  They might respond to the name %VIEWERNAME% but honestly I never did much training, so no guarantees!  Help PLEASE!";
        case 12:  return "15% off all drinks at the Underworld Tavern!  Tell the bartender %VIEWERNAME% sent you!";
        case 13:  return "Do you want to be your own boss?  Do you want to have additional revenue streams?  Do you want to grow your own business?  Attend a presentation this weekend by %VIEWERNAME% to learn about the amazing possibilities!";
        case 14:  return "Wow, Crowd Control sure is neat!  At least, %VIEWERNAME% certainly seems to think so!";
        case 15:  return "Mechanical augmentations got you down?  Need your latest dose of neuropozyne but don't have the credits to get it?  Buy cheap Nu-Poz from the Canadian %VIEWERNAME% Online Pharmacy today!  Prices are less than half"$" what you might pay in your local pharmacy!";
        case 16:  return "Hi.  I want to offer promotion of your channel, viewers, followers, views, chat bots.  The price is lower than any competitor, the quality is guaranteed to be the best."$"  Auto-in.  Incredibly flexible and convenient"$" order management panel, everything is in your hands, turn it on/off/customize.  Go to %VIEWERNAME% dot com";
        case 17:  return "Hi, this is %VIEWERNAME%.  It seems you are a beginner.  I can improve the appearance of your channel with awesome ideas that would give your channel a professional look."$"  I have been a professional artist and "$"graphic designer for over a decade, and designed my own graphics for said stream";
        case 18:  return "We've been trying to reach you concerning your vehicle's extended warranty.  You should've received a notice in the mail about your car's extended warranty eligibility."$"  Since we've not gotten a response, we're "$"giving you a final courtesy datacube before we close out your file.  Please contact %VIEWERNAME% to learn more about possibly extending or reinstating your vehicle's warranty.";
        case 19:  return "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  Ut enim ad minim veniam,"$" quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.  Duis aute irure dolor in reprehenderit in voluptate"$" velit esse cillum dolore eu fugiat nulla pariatur.  Excepteur sint occaecat cupidatat non"$" proident, sunt in culpa qui officia deserunt mollit anim id est laborum.|n|n  -%VIEWERNAME%";
        case 20:  return "hi every1 im new!!!!!!! *holds up spork* my name is %VIEWERNAME% but u can call me t3h PeNgU1N oF d00m!!!!!!!! lol...as u can see im very random!!!!"$" thats why i came here, 2 meet random ppl like me ^_^... im 13 years old (im mature 4 my age tho!!) i like 2 watch invader zim w/ my girlfreind"$" (im bi if u dont like it deal w/it) its our favorite tv show!!! bcuz its SOOOO random!!!! shes random 2 of course but i want 2 meet more random ppl =) "$"like they say the more the merrier!!!! lol...neways i hope 2 make alot of freinds here "$"so give me lots of commentses!!!!|nDOOOOOMMMM!!!!!!!!!!!!!!!! <--- me bein random again ^_^ hehe...toodles!!!!!"$"|n|nlove and waffles,|n|nt3h PeNgU1N oF d00m";
        case 21:  return "%VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% "$"%VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% "$"%VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME%"$" %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% "$"%VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME%"$" %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME% %VIEWERNAME%";
        case 22:  return "%VIEWERNAME% has a document for your review|n------------------------------------------------------|n|n  %VIEWERNAME% has shared a document with you:|n|n        <invoice.pdf>|n|n|nClick here to open";
        case 23:  return "Your password changed|n|nYour password for your account %VIEWERNAME%@NYCNet was changed.|n|nIf this was you, then you can safely ignore this datacube.|n|n|nIf this wasn't you, your account has been compromised.  Please follow these steps"$"|n1) Reset your password|n2) Review your security info|n3) Learn how to make your account more secure."$"|n|nYou can also opt out or change where you receive security notifications.|n|nThanks,|nThe NYCNet account team";
        case 24:  return "Fed-UPS Failed Delivery Attempt|n|nDear %VIEWERNAME%,|n|nWe have attempted to deliver your item!"$"|n|nThe delivery attempt failed because nobody was present at the shipping address, so this datacube has been automatically sent.  "$"You may arrange re-delivery by visiting the nearest Fed-UPS office with the printed shipping invoice mentioned below."$"|n|nIf the package is not scheduled for delivery or picked up within 48 hours, it will be returned to the sender.|n|n<invoice.pdf>";
        case 25:  return "Hello Dear,|nI am %VIEWERNAME%, the widow of the Late Nigerian Head of State.  I am presently in distress and under house arrest while my son is undergoing trial,"$" though he has just been recently granted bail under the condition that my family refunds to the Federal Government some amount of money.  "$"The government has frozen all the family account and auctioned all our properties.  Refer to this website about my husband's loot and you will understand what I mean.|n"$"To save the family from total bankruptcy I have managed to ship through an undercover courier company, the sum of 6.5 Billion Credits, kept by my late partner.  "$"The money was disguised to beat the Nigerian Security and it is currently deposited in a security company which I will disclose the name and contacts to you if I get a positive response from you.  "$"I want you to receive the money and pay into your account for the family safely.  I am offering you 30% for assisting me secure this money"$"  Contact me immediately with my email address so that I can forward to you all necessary details.  "$"Endeavor to send your phone and fax numbers for easy Communications.  This project is not risky.|nBest Regards.|n%VIEWERNAME%";
        case 26:  return "Hi, I'm %VIEWERNAME%|n|nIt is a pleasure to meet you.|n|nHave a nice day!";
        case 27:  return "Hey guys, did you know that in terms of streamer and viewer interactions, "$"%VIEWERNAME% is the most compatible with streamers?  "$"Not only are they in the Crowd Control user group, which is mostly comprised of humans, %VIEWERNAME%"$" likes to use their Crowd Control coins, which means they're able to help and hinder the streamer, and with their impressive choice of Crowd Control effects, you can blame them for all of your failures."$"  Due to their mostly chat based interactions, there's no doubt in my mind that an amused %VIEWERNAME% "$"would be incredibly engaged, so engaged that you could easily stream for them for hours without getting bored."$"  They can also use the effects Ask A Question, Resident Evil Mode, Full Heal, Gotta Go Fast, and Nudge, along with all the rest of the effects, so it'd be incredibly easy for them to stay engaged."$"  With the ability to redeem free coins or to buy more, they can easily send effects with enough money.  No other viewer comes close to this level of engagement."$"  Also, fun fact, if you keep using Crowd Control enough, you can keep your viewers absolutely engaged.  %VIEWERNAME% "$"is literally built to use Crowd Control.  Ungodly effect choice+spare time+good memes means they can watch streams all day, no matter who and still come back for more";
        case 28:  return "Skeletons?  In your own body?  It's more likely than you think.|n|nHi, I'm %VIEWERNAME% and I'm a certified skeleton fighter.  I can help YOU remove the skeleton from your body *before* it becomes a problem."$"  Get in touch with me on NYCNET today to find out how YOU can deal with YOUR undead problem TODAY!";
        case 29:  return "The %VIEWERNAME%(tm) Pacer Test is a multistage aerobic capacity test that progressively gets more difficult as it continues. The 20 meter pacer test will begin in 30 seconds. Line up at the start."$" The running speed starts slowly but gets faster each minute after you hear this signal *BEEP*. A single lap should be completed every time you hear this sound."$"  *DING* Remember to run in a straight line and run as long as possible. The second time you fail to complete a lap before the sound, your test is over. The test will begin on the word start. On your mark. Get ready!... Start.";
        case 30:  return "---Deus Ex Roleplay Club---|n|n"$"is rescheduled for 7:30 at the Underworld Tavern.|n|n"$"If you can come, text %VIEWERNAME%"$" but dont curse becuz its my moms phone|n|n|nP.S. we need a Sandra and a Jojo we DONT need anymore JCs im already jc";
        case 31:  return "---LOST FLY---|n|nI'm %VIEWERNAME% and I saw this fly and my mom let it out the window!  BTW I named him harley.  He (or she) is a centameter big and if you find him"$" tell him I said hi.  But watever you do dont bring him back he will get killed by a fly swatter.|n|n"$"WARNING: Do not touch him he WILL throw up";
        case 32:  return "Garlic Secrets #41, by %VIEWERNAME%|n|nApply garlic to a freshly opened cut or burn to immediately intensify the pain";
        case 33:  return "We do NOT sell tuna milkshakes, so please don't ask|n|n"$"I've got nothing against tuna.  I like tuna.  In a baked potato or a sandwich it's great and it's got lots of omega-3 which is good for you.  "$"But TUNA in a milkshake is just wrong.  Why don't you have an Oreo Milkshake or a Strawberry Millions, or Dime Bar, or Mars Bar or any of the 70+ flavours on the menu.  "$"But please, please stop asking for Tuna Milkshakes.|n|nThanks,|n  -%VIEWERNAME%";
        case 34:  return "Enjoying Deus Ex Randomizer?  Why not pick up some merch at |n|nshop.mods4ever.com|n|nThis message brought to you by %VIEWERNAME%";
        case 35:  return "Writing's not easy.  That's why %VIEWERNAME% can help.  This sentence is grammatically correct, but it's worody, and hard to read.  "$"It undermines the writer's message and the word choice is bland.  %VIEWERNAME%'s cutting edge technology helps you craft"$" compelling, understandable writing that makes and impact on your reader."$"  Much better.  Are you ready to give it a try?  Installation is simple and free.  Speak with %VIEWERNAME% today!";
    }

    return "SOMEHOW FAILED TO GENERATE SPAM MESSAGE FOR %VIEWERNAME% SO ENJOY THIS COMPLIMENTARY ERROR DATACUBE INSTEAD";
}
...
function bool SpamDatacubes(String viewer)
{
    ...
    num = 0;
    for (i=0;i<5;i++){
        cubeText = RandomSpamDatacubeText();
        cubeText = ReplaceKeywords(cubeText,viewer);
