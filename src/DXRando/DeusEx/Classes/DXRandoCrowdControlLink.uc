...
function int RandomOfflineEffects() {
    ...
    case 94: return ccEffects.doCrowdControlEvent("spam_datacubes", param, viewer, 0, 0);
#ifdef vanilla
    case 95: return ccEffects.doCrowdControlEvent("wine_bullets", param, viewer, 0, 0);
#endif
    case 96: return ccEffects.doCrowdControlEvent("blood_god", param, viewer, 0, 0);
#ifndef vmd
    ...
    case 100: return ccEffects.doCrowdControlEvent("give_current_ammo", param, viewer, 0, 0);
    case 101: return ccEffects.doCrowdControlEvent("clone_player_evil", param, viewer, 0, 0);
    case 102: return ccEffects.doCrowdControlEvent("clone_player_good", param, viewer, 0, 0);
    }
