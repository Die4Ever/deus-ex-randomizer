...
function LoadQuotes()
{
    ...
    AddQuote("IT'S DANGEROUS TO GO ALONE!  TAKE THIS", "OLD MAN");
    ...
    AddQuote("A MAN CHOOSES, A SLAVE OBEYS", "ANDREW RYAN");
    AddQuote("STOP RIGHT THERE, CRIMINAL SCUM!", "IMPERIAL WATCHMAN");
    AddQuote("DO YOU LIKE HURTING OTHER PEOPLE?", "RICHARD");
    AddQuote("THE ONLY THING THAT CAN DEFEAT POWER, IS MORE POWER", "ALBERT WESKER");
    AddQuote("YOU MUST DEFEAT SHENG LONG TO STAND A CHANCE", "RYU"); // https://en.wikipedia.org/wiki/Sheng_Long
    AddQuote("FEW ANT COLONIES LAST VERY LONG, BUT MAYBE, WITH YOUR HELP, THIS ONE WILL SURVIVE", "SIMANT");

    //Metal Gear
    AddQuote("UNFORTUNATELY, KILLING IS ONE OF THOSE THINGS THAT GETS EASIER THE MORE YOU DO IT.","SOLID SNAKE");
    AddQuote("DO YOU THINK LOVE CAN BLOOM EVEN ON A BATTLEFIELD?","OTACON");
    AddQuote("REAL HEROES ARE NEVER AS POLISHED AS THE LEGENDS THAT SURROUND THEM.","BIG BOSS");
    AddQuote("...CAN YOU HEAR ME?  SOLID SNAKE... I'M NOT DEAD... SOMEDAY, I'LL GET EVEN WITH YOU.  SOMEDAY... WE WILL MEET AGAIN!","BIG BOSS");
    AddQuote("I HEAR IT'S AMAZING WHEN THE FAMOUS PURPLE STUFFED WORM IN FLAP-JAW SPACE WITH THE TUNING FORK DOES A RAW BLINK ON HARA-KIRI ROCK.  I NEED SCISSORS!  61!","COLONEL");
    AddQuote("I WAS A NORTH AMERICAN FALL WEBWORM IN MY PAST LIFE.  THOSE WERE THE GOOD OLD DAYS...","COLONEL");
    AddQuote("WE'RE NOT TOOLS OF THE GOVERNMENT OR ANYONE ELSE.  FIGHTING WAS THE ONLY THING... THE ONLY THING I WAS GOOD AT... BUT AT LEAST I ALWAYS FOUGHT FOR WHAT I BELIEVED IN.","GRAY FOX");
    AddQuote("NANOMACHINES, SON.","SENATOR ARMSTRONG");
    AddQuote("WAR HAS CHANGED.  IT'S NO LONGER ABOUT NATIONS, IDEOLOGIES, OR ETHNICITY.  IT'S AN ENDLESS SERIES OF PROXY BATTLES, FOUGHT BY MERCENARIES AND MACHINES.  WAR, AND ITS CONSUMPTION OF LIFE, HAS BECOME A WELL-OILED MACHINE.  WAR HAS CHANGED.  "$"ID-TAGGED SOLDIERS CARRY ID-TAGGED WEAPONS, USE ID-TAGGED GEAR.  NANOMACHINES INSIDE THEIR BODIES ENHANCE AND REGULATE THEIR ABILITIES.  GENETIC CONTROL.  INFORMATION CONTROL.  EMOTION CONTROL.  BATTLEFIELD CONTROL.  "$"EVERYTHING IS MONITORED AND KEPT UNDER CONTROL.  WAR HAS CHANGED.  THE AGE OF DETERRENCE HAS BECOME THE AGE OF CONTROL.  ALL IN THE NAME OF AVERTING CATASTROPHE FROM WEAPONS OF MASS DESTRUCTION.  AND HE WHO CONTROLS THE BATTLEFIELD CONTROLS HISTORY.  "$"WAR HAS CHANGED.  WHEN THE BATTLEFIELD IS UNDER TOTAL CONTROL, WAR... BECOMES ROUTINE.","OLD SNAKE");
    ...
    AddQuote("SRORRIM ERA EROM NUF NAHT NOISIVELET?", "FLAMINGO");
    ...
    //The Matrix
    AddQuote("WHOA", "NEO");
    AddQuote("THIS IS YOUR LAST CHANCE.  AFTER THIS, THERE IS NO TURNING BACK.  YOU TAKE THE BLUE PILL - THE STORY ENDS, YOU WAKE UP IN YOUR BED AND BELIEVE WHATEVER YOU WANT TO BELIEVE."$"  YOU TAKE THE RED PILL - YOU STAY IN WONDERLAND AND I SHOW YOU HOW DEEP THE RABBIT HOLE GOES.", "MORPHEUS");
    AddQuote("I'D LIKE TO SHARE A REVELATION THAT I'VE HAD DURING MY TIME HERE.  IT CAME TO ME WHEN I TRIED TO CLASSIFY YOUR SPECIES AND I REALIZED YOU'RE NOT ACTUALLY MAMMALS."$"  EVERY MAMMAL ON THIS PLANET INSTINCTIVELY DEVELOPS A NATURAL EQUILIBRIUM WITH THE SURROUNDING ENVIRONMENT BUT YOU HUMANS DO NOT.  YOU MOVE TO AN AREA AND YOU MULTIPLY AND MULTIPLY UNTIL"$" EVERY NATURAL RESOURCE IS CONSUMED AND THE ONLY WAY YOU CAN SURVIVE IS TO SPREAD TO ANOTHER AREA.  THERE IS ANOTHER ORGANISM ON THIS PLANET THAT FOLLOWS THE SAME PATTERN."$"  DO YOU KNOW WHAT IT IS?  A VIRUS.  HUMAN BEINGS ARE A DISEASE, A CANCER OF THIS PLANET.  YOU'RE A PLAGUE AND WE ARE THE CURE.", "AGENT SMITH");
    AddQuote("YOU KNOW, I KNOW THIS STEAK DOESN'T EXIST.  I KNOW THAT WHEN I PUT IT IN MY MOUTH, THE MATRIX IS TELLING MY BRAIN THAT IT IS JUICY AND DELICIOUS."$"  AFTER NINE YEARS, YOU KNOW WHAT I REALIZE?  IGNORANCE IS BLISS.", "CYPHER");
    AddQuote("NEVER SEND A HUMAN TO DO A MACHINE'S JOB", "AGENT SMITH");
    AddQuote("YOU HEAR THAT MR. ANDERSON?... THAT IS THE SOUND OF INEVITABILITY... IT IS THE SOUND OF YOUR DEATH... GOODBYE, MR. ANDERSON...", "AGENT SMITH");
    AddQuote("WHAT ARE YOU WAITING FOR?  YOU'RE FASTER THAN THIS.  DON'T THINK YOU ARE, KNOW YOU ARE.  COME ON.  STOP TRYING TO HIT ME AND HIT ME.", "MORPHEUS");
    AddQuote("TO DENY OUR OWN IMPULSES IS TO DENY THE VERY THING THAT MAKES US HUMAN.", "MOUSE");
    AddQuote("WHAT IS REAL?  HOW DO YOU DEFINE 'REAL'?  IF YOU'RE TALKING ABOUT WHAT YOU CAN FEEL, WHAT YOU CAN SMELL, WHAT YOU CAN TASTE AND SEE, THEN 'REAL' IS SIMPLY ELECTRICAL SIGNALS INTERPRETED BY YOUR BRAIN.", "MORPHEUS");
