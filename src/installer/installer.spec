...
a_bingo = Analysis(
    ...
    binaries=[],
    datas=[
        ('../BingoViewer/icon_16.png', '.'),
        ('../BingoViewer/icon_32.png', '.'),
        ('../BingoViewer/icon_48.png', '.'),
        ('../BingoViewer/icon_64.png', '.'),
        ('../BingoViewer/icon_128.png', '.'),
    ],
...
exe_bingo = EXE(
    ...
    *bingo_includes,
    [],
    name='BingoViewer',
    icon='../BingoViewer/icon.ico' if IsWindows() else None,
    debug=False,
    bootloader_ignore_signals=False,
    strip=False,
    upx=True,
