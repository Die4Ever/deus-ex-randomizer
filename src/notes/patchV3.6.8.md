...
- Improvements to Fixed Camera mode:
  ...
  - The "Doom Mode" Crowd Control effect now works properly in combination with Fixed Cameras.  The player is unable to aim up or down, but the fixed camera itself is able to tilt still.
  - The aim laser no longer shows up during conversations or cutscenes in Revision.
- Fixed an infinite conversation loop in Mission 5 MJ12 Lab when you buy everything from Sven the mechanic.
